...
const Banner = () => {
    ...
    return (
        <div className='container py-5 home-banner'>
            <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
                <SwiperSlide>
                    <div className="slider-item relative">
                        <img src={img1} alt="slider img" className='w-full h-full object-cover rounded-xl slider-img' />
                        <div className="text-content absolute top-0 left-0 w-full h-full rounded-xl flex items-center p-12 md:p-24 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
                            <div className="lg:w-1/2">
                                <h2 className='md:text-6xl text-3xl text-white font-bold'>Affordable <br /> Price For Car <br /> Servicing</h2>
                                <p className='text-lg text-white mt-4 mb-3'>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
                ...
                <SwiperSlide>
                    <div className="slider-item relative">
                        <img src={img2} alt="slider img" className='w-full h-full object-cover rounded-xl slider-img' />
                        <div className="text-content absolute top-0 left-0 w-full h-full rounded-xl flex items-center p-12 md:p-24 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
                            <div className="lg:w-1/2">
                                <h2 className='md:text-6xl text-3xl text-white font-bold'>Affordable <br /> Price For Car <br /> Servicing</h2>
                                <p className='text-lg text-white mt-4 mb-3'>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
                ...
                <SwiperSlide>
                    <div className="slider-item relative">
                        <img src={img3} alt="slider img" className='w-full h-full object-cover rounded-xl slider-img' />
                        <div className="text-content absolute top-0 left-0 w-full h-full rounded-xl flex items-center p-12 md:p-24 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
                            <div className="lg:w-1/2">
                                <h2 className='md:text-6xl text-3xl text-white font-bold'>Affordable <br /> Price For Car <br /> Servicing</h2>
                                <p className='text-lg text-white mt-4 mb-3'>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
                ...
                <SwiperSlide>
                    <div className="slider-item relative">
                        <img src={img4} alt="slider img" className='w-full h-full object-cover rounded-xl slider-img' />
                        <div className="text-content absolute top-0 left-0 w-full h-full rounded-xl flex items-center p-12 md:p-24 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
                            <div className="lg:w-1/2">
                                <h2 className='md:text-6xl text-3xl text-white font-bold'>Affordable <br /> Price For Car <br /> Servicing</h2>
                                <p className='text-lg text-white mt-4 mb-3'>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
